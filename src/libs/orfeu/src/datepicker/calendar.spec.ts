...
import {DEC, FEB, JAN, AplsNativeDateModule, NOV} from '../core';
...
describe('AplsCalendar', () => {
  ...
  describe('standard calendar', () => {
    ...
    it('should re-render when the i18n labels have changed',
      inject([AplsDatepickerIntl], (intl: AplsDatepickerIntl) => {
        const button = fixture.debugElement.nativeElement
            .querySelector('.apls-calendar-period-button');
    ...
    describe('a11y', () => {
      describe('calendar body', () => {
        ...
        beforeEach(() => {
          calendarBodyEl = calendarElement.querySelector('.apls-calendar-content') as HTMLElement;
        ...
        it('should not move focus to the active cell on init', () => {
          const activeCell =
              calendarBodyEl.querySelector('.apls-calendar-body-active')! as HTMLElement;
        ...
        describe('year view', () => {
          beforeEach(() => {
            ...
            (calendarBodyEl.querySelector('.apls-calendar-body-active') as HTMLElement).click();
            fixture.detectChanges();
          ...
          it('should return to month view on enter', () => {
            const tableBodyEl = calendarBodyEl.querySelector('.apls-calendar-body') as HTMLElement;
  ...
  describe('calendar with min and max date', () => {
    ...
    it('should not go back past min date', () => {
      ...
      let prevButton =
          calendarElement.querySelector('.apls-calendar-previous-button') as HTMLButtonElement;
    ...
    it('should not go forward past max date', () => {
      ...
      let nextButton =
          calendarElement.querySelector('.apls-calendar-next-button') as HTMLButtonElement;
    ...
    it('should re-render the year view when the minDate changes', () => {
      fixture.detectChanges();
      const periodButton =
          calendarElement.querySelector('.apls-calendar-period-button') as HTMLElement;
      periodButton.click();
      fixture.detectChanges();
  ...
  describe('calendar with date filter', () => {
    ...
    it('should disable and prevent selection of filtered dates', () => {
      let cells = calendarElement.querySelectorAll('.apls-calendar-body-cell');
    ...
    describe('a11y', () => {
      ...
      beforeEach(() => {
        tableBodyEl = calendarElement.querySelector('.apls-calendar-body') as HTMLElement;
...
@Component({
  template: `
    <apls-calendar [startAt]="startAt" [minDate]="minDate" [maxDate]="maxDate"></apls-calendar>
  `
})
...
@Component({
  template: `
    <apls-calendar [startAt]="startDate" [(selected)]="selected" [dateFilter]="dateFilter">
    </apls-calendar>
  `
})
