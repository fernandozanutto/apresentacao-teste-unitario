...
describe('AplsMonthView', () => {
  ...
  describe('standard month view', () => {
    ...
    beforeEach(() => {
      ...
      let monthViewDebugElement = fixture.debugElement.query(By.directive(AplsMonthView));
      monthViewNativeElement = monthViewDebugElement.nativeElement;
      testComponent = fixture.componentInstance;
    });

    it('has correct month label', () => {
      let labelEl = monthViewNativeElement.querySelector('.apls-calendar-body-label')!;
      expect(labelEl.innerHTML.trim()).toBe('JAN');
    });

    it('has 31 days', () => {
      let cellEls = monthViewNativeElement.querySelectorAll('.apls-calendar-body-cell')!;
      expect(cellEls.length).toBe(31);
    });

    it('shows selected date if in same month', () => {
      let selectedEl = monthViewNativeElement.querySelector('.apls-calendar-body-selected')!;
    ...
    it('should mark active date', () => {
      ...
      expect(cellEls[4].classList).toContain('apls-calendar-body-active');
    });
    ...
    describe('a11y', () => {
      describe('calendar body', () => {
        ...
        it('should go to beginning of the month on aplicacao press', () => {
  ...
  describe('month view with date filter', () => {
    ...
    it('should disable filtered dates', () => {
      let cells = monthViewNativeElement.querySelectorAll('.apls-calendar-body-cell');
...
@Component({
  template: `<apls-month-view [(activeDate)]="date" [(selected)]="selected"></apls-month-view>`,
})
...
@Component({
  template: `<apls-month-view [activeDate]="activeDate" [dateFilter]="dateFilter"></apls-month-view>`
})
