...
import {AplsProgressBarModule} from '.';


describe('AplsProgressBar', () => {

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [AplsProgressBarModule],
      declarations: [
        BasicProgressBar,
        BufferProgressBar,
      ],
  ...
  describe('basic progress-bar', () => {
    ...
    it('should apply a mode of "determinate" if no mode is provided.', () => {
      let progressElement = fixture.debugElement.query(By.css('apls-progress-bar'));
...
@Component({template: '<apls-progress-bar></apls-progress-bar>'})
class BasicProgressBar { }

@Component({template: '<apls-progress-bar mode="buffer"></apls-progress-bar>'})
