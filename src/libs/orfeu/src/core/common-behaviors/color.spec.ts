...
describe('MixinColor', () => {
  ...
  it('should remove old color classes if new color is set', () => {
    ...
    expect(instance.testElement.classList)
      .toContain('apls-primary', 'Expected the element to have the "apls-primary" class set');

    instance.color = 'accent';

    expect(instance.testElement.classList)
      .not.toContain('apls-primary', 'Expected the element to no longer have "apls-primary" set.');
    expect(instance.testElement.classList)
      .toContain('apls-accent', 'Expected the element to have the "apls-accent" class set');
  });
  ...
  it('should allow having a default color if specified', () => {
    ...
    expect(instance.testElement.classList)
      .toContain('apls-accent', 'Expected the element to have the "apls-accent" class by default.');

    instance.color = undefined;

    expect(instance.testElement.classList)
      .toContain('apls-accent', 'Expected the default color "apls-accent" to be set.');
  });
