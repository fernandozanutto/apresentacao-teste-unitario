...
@Component({
  ...
  host: {
    class: 'apls-tab-header',
    '[class.apls-tab-header-pagination-controls-enabled]':
      '_showPaginationControls',
    '[class.apls-tab-header-rtl]': "_getLayoutDirection() == 'rtl'"
  }
})
export class AplsTabHeader
